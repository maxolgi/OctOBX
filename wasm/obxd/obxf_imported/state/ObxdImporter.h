...
// WASM AWP build: juce_audio_processors (the FULL module) cannot be
// built (its .cpp unconditionally #include's juce_gui_extra/juce_gui_extra.h
// and PluginHostType.cpp hard-#error's under JUCE_WASM). The headless
// split exposes the identical juce::AudioProcessor / XmlElement /
// MemoryBlock / String API that ObxdImporter actually consumes.
// juce_amalgam.cpp amalgamates juce_audio_processors_headless.cpp.
