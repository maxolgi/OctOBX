...
// WASM AWP build: juce_audio_processors (full) cannot be built here.
// The headless split is sufficient (see the matching note in
// ObxdImporter.h and juce_amalgam.cpp).
